...
main()
{
	...
	//---------------------------------------------------------------------
	// Find all new ol destructibles by their targetnames and run the setup
	//---------------------------------------------------------------------
...
setup_destructibles_ol( cached )
{
	...
	self.destuctableInfo = common_scripts\_destructible_types_ol::makeType_ol( self.destructible_type );
	...
	self.targetname = self.targetname + "_ol";
